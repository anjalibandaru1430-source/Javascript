...
//printing all the brands and models of cars using for loop
for(let i=0;i<cars.length;i++){
    console.log(cars[i].brand);
}

//printing all the models of cars using for loop
for(let i=0;i<cars.length;i++){
    console.log(cars[i].model);
}
//printing all the red color  cars using for loop
for(let i=0;i<cars.length;i++){
    if(cars[i].color==="Red"){
        console.log(cars[i]);
    }
...
//printing all red colored cars using for of loop
for(let car of cars){
    if(car.color==="Red"){
        console.log(car);
    }
...
//printing all cars which are priced below 1000000 using for of loop
for(let car of cars){
...
//printing all cars which are priced below 1000000 using for  loop
for(let i=0;i<cars.length;i++){
